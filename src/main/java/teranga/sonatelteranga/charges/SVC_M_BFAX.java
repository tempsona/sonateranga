...
public class SVC_M_BFAX extends Charge {
 ...
 //        addParametre(new ChargeParametre(this.getCode(), "MSISDN_F", "Numéro secondaire pour service BasicFAX, uniquement si le service BasicFAX utilise un numéro différent du numéro principal", TYPE_PARAMETRE.STRING, null, true, "X", null,"EXTERNE"));
        setEtat(ETAT.ACTIF);
        setObligatoire(true);
    }
