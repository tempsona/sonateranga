 ...
 * @author sidibe0091
 */
public class CM_FAVORIS_INT_ABO extends Charge {

    public CM_FAVORIS_INT_ABO(String code, TYPE_CHARGE type) {
        super(code, type, TYPE_EVENT.SOUSCRIPTION, false);
        setDescription("Numéro Préféré International");
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_FAVORIS_INT_ABO.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
