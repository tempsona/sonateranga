 ...
 * @author sidibe0091
 */
public class CM_CHANGEMENT_SIM_MICRO extends Charge {

    public CM_CHANGEMENT_SIM_MICRO(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        setDescription("Changement de Carte Micro SIM");
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_CHANGEMENT_SIM_MICRO.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
