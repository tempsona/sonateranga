 ...
 * @author sidibe0091
 */
public class CM_GESTE_COMMERCIAL extends Charge {

    public CM_GESTE_COMMERCIAL(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        setDescription("Geste Commercial");
        addParametre(new ChargeParametre(this.getCode(),"MONTANT_GESTE", "Montant geste", TYPE_PARAMETRE.NUMBER, 100000, true, null, null,"EXTERNE"));
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_GESTE_COMMERCIAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}