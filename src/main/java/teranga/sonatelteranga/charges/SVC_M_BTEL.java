 ...
 * @author sidibe0091
 */
public class SVC_M_BTEL extends Charge{
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(SVC_M_BTEL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }

    public SVC_M_BTEL(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        this.setDescription("Téléphonie de Base");
        setObligatoire(true);
        setEtat(ETAT.ACTIF);
