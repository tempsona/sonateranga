 ...
 * @author sidibe0091
 */
public class SVC_M_3G extends Charge {

    public SVC_M_3G(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type.SERVICE, declencheur, true);        
        setDescription("Visio 3G");
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(SVC_M_3G.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
