 ...
 * @author sidibe0091
 */
public class CM_CHANGEMENT_NUMERO extends Charge {

    public CM_CHANGEMENT_NUMERO(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        this.setDescription("Changement de numéro MSISDN");
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_CHANGEMENT_NUMERO.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
