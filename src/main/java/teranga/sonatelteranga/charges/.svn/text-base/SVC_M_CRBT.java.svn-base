 ...
 * @author sidibe0091
 */
public class SVC_M_CRBT extends Charge {

    public SVC_M_CRBT(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
         setDescription("Wele Tones");
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(SVC_M_CRBT.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
