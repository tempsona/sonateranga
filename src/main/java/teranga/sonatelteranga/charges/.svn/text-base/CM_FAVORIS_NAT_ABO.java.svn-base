 ...
 * @author sidibe0091
 */
public class CM_FAVORIS_NAT_ABO extends Charge {

    public CM_FAVORIS_NAT_ABO(String code, TYPE_CHARGE type) {
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_FAVORIS_NAT_ABO.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
