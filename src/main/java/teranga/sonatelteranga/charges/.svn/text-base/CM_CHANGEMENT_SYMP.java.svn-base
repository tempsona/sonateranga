 ...
 * @author sidibe0091
 */
public class CM_CHANGEMENT_SYMP extends Charge {

    public CM_CHANGEMENT_SYMP(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        setDescription("Changement de numéro sympathique");
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_CHANGEMENT_SYMP.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
