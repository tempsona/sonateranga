 ...
 * @author sidibe0091
 */
public class CM_CESSION extends Charge {

    public CM_CESSION(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        this.setDescription("Cession de ligne");
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_CESSION.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
