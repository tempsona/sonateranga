 ...
 * @author sidibe0091
 */
public class CM_FAVORIS_ORANGE_ZONE_CHANGEMENT extends Charge {

    public CM_FAVORIS_ORANGE_ZONE_CHANGEMENT(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_FAVORIS_ORANGE_ZONE_CHANGEMENT.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
