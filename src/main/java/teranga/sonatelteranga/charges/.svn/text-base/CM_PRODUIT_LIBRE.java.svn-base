 ...
 */
public class CM_PRODUIT_LIBRE extends Charge {

    public CM_PRODUIT_LIBRE(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        setDescription("Produit libre");
    ...
    public List<Conso> getConso(Contrat arg0) {
        ...
        try {
            ...
            Logger.getLogger(CM_PRODUIT_LIBRE.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
