 ...
 * @author sidibe0091
 */
public class SVC_M_GPRS extends Charge {

    public SVC_M_GPRS(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type.SERVICE, declencheur, true);
        setDescription("GPRS, inclus Internet + Wap + MMS");
        setEtat(ETAT.ACTIF);
        setObligatoire(true);
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(SVC_M_GPRS.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
