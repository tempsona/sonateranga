 ...
 * @author sidibe0091
 */
public class SVC_M_CHS extends Charge {

    public SVC_M_CHS(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        setEtat(ETAT.ACTIF);
        setObligatoire(true);
        setDescription("Appel en attente");
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(SVC_M_CHS.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
