 ...
 * @author sidibe0091
 */
public class CM_SIM_DUO extends Charge {

    public CM_SIM_DUO(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        setDescription("SIM Duo");
        addParametre(new ChargeParametre(this.getCode(), "SIMSUO_TYPE", "Type de sim duo", TYPE_PARAMETRE.STRING, null, true, "NEW", null, "INTERNE"));
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_SIM_DUO.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
