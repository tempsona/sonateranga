 ...
 * @author sidibe0091
 */
public class CM_FAVORIS_NAT_CHANGEMENT extends Charge {

    public CM_FAVORIS_NAT_CHANGEMENT(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        setDescription("Changement de Numéro Favoris National");
        addParametre(new ChargeParametre(code, "NUMERO_PREFERE_1", "Numéro préféré 1", TYPE_PARAMETRE.STRING, null, false, "X", null, "EXTERNE"));
        addParametre(new ChargeParametre(this.getCode(), "NBNUMEROSNAT", "Nombre de numéro national", TYPE_PARAMETRE.NUMBER, 1, true, null, null, "EXTERNE"));
    }
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(CM_FAVORIS_NAT_CHANGEMENT.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
