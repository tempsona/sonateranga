 ...
 * @author sidibe0091
 */
public class SVC_M_CTS extends Charge {

    public SVC_M_CTS(String code, TYPE_CHARGE type, TYPE_EVENT declencheur, boolean aProvisionner) {
        super(code, type, declencheur, aProvisionner);
        setDescription("Transfert d'appel");
    ...
    public List<Conso> getConso(Contrat contrat) {
        ...
        try {
            ...
            Logger.getLogger(SVC_M_CTS.class.getName()).log(Level.SEVERE, null, ex);
        }
        return lc;
    }
}
